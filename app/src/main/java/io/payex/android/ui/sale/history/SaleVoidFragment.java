...
public class SaleVoidFragment extends BottomSheetDialogFragment {
    ...
    public void setupDialog(Dialog dialog, int style) {
        ...
        View contentView = View.inflate(getContext(), R.layout.fragment_sale_void, null);
    ...
    public void confirmVoid() {
        dismiss();
        mListener.onConfirmVoidButtonPressed();
    }
    ...
    public interface OnFragmentInteractionListener {
        void onConfirmVoidButtonPressed();
    }
}
