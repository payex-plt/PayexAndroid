...
/**
 * Created by vince on 2/6/2017.
 */

public class NewDateRangePickerFragment extends DialogFragment implements View.OnClickListener {
    ...
    public NewDateRangePickerFragment() {
        // Required empty public constructor
    }

    public static NewDateRangePickerFragment newInstance(OnDateRangeSelectedListener callback, boolean is24HourMode) {
        NewDateRangePickerFragment dateRangePickerFragment = new NewDateRangePickerFragment();
